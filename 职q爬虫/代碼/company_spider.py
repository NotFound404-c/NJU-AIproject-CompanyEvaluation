...
def companyspider(cookie, n, list1, short_list, dft):
    dictt = {}
    ...
    i = 0
    while True:
        target_url = f"https://zq.zhaopin.com/gongsidianping/0-0-{list1[n]}-{i}"
        ...
        if i == 0 and companies_info == []:
            c, d = companyspiderr(cookie, n, list1, short_list, dft)
            return c, d
